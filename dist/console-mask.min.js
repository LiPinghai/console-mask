(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["console-mask"] = factory();
	else
		root["console-mask"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConsoleMask = function () {
	  function ConsoleMask() {
	    var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	
	    _classCallCheck(this, ConsoleMask);
	  ...
	  ConsoleMask.prototype.init = function init() {
	    this.insertDom();
	    return _avalon2["default"].define({
	      $id: 'console-mask',
	      logs: [],
	      isSpread: false,
	  ...
	  ConsoleMask.prototype.insertDom = function insertDom() {
	    var consoleDom = document.createElement('div');
	  ...
	  ConsoleMask.prototype.mockConsole = function mockConsole() {
	    var that = this;
	    if (!window.console) {
	      window.console = {};
	    } else {
	  ...
	  ConsoleMask.prototype.printLog = function printLog(args) {
	    this.vm.logs.push(args.logs[0]);
	  };
	
	  ConsoleMask.prototype.show = function show() {
	    this.vm.isSpread = true;
	  };
	
	  ConsoleMask.prototype.hide = function hide() {
	    this.vm.isSpread = false;
	  };
	
	  ConsoleMask.prototype.spreadToggle = function spreadToggle() {
	    this.vm.isSpread = !this.vm.isSpread;
	  };
	
	  ConsoleMask.prototype.clear = function clear() {
	    this.vm.logs = [];
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./console-mask.scss", function() {
				var newContent = require("!!./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./console-mask.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "#console-mask {\n  bottom: 0;\n  width: 100%;\n  height: 0px;\n  color: #fff;\n  background-color: rgba(0, 0, 0, 0.5);\n  position: fixed;\n  z-index: 100000; }\n  #console-mask.spread {\n    height: 200px; }\n  #console-mask .btn-spread {\n    background-color: rgba(0, 0, 0, 0.5);\n    width: 50px;\n    height: 30px;\n    text-align: center;\n    line-height: 30px;\n    display: inline-block;\n    position: absolute;\n    left: 50%;\n    margin-left: -20px; }\n  #console-mask.type-top {\n    top: 0; }\n    #console-mask.type-top .btn-spread {\n      bottom: -30px;\n      border-radius: 0px 0px 5px 5px; }\n  #console-mask.type-bottom {\n    bottom: 0; }\n    #console-mask.type-bottom .btn-spread {\n      top: -30px;\n      border-radius: 5px 5px 0px 0px; }\n  #console-mask ul {\n    position: relative;\n    height: 100%;\n    overflow-y: auto;\n    overflow-x: hidden;\n    bottom: 0; }\n    #console-mask ul li {\n      padding-left: 10px; }\n", ""]);
